  ...
  return (
    <div className="app">
      <header className="app-header">
        ...
        <p>
          Advanced AI-powered document privacy protection. Automatically detect
          and mask sensitive personal information from your ID documents with
        ...
        {!showPreview ? (
          ...
          <>
            ...
            <div className="preview-container">
              <ImagePreview image={originalImage} title="Original Document" />

              {showResults && (
                <ImagePreview image={maskedImage} title="Protected Document" />
              )}
            </div>
            ...
            {hasPII && (
              <div className="pii-results">
                ...
                >
                  The following sensitive information was automatically detected
                  and protected:
                </p>
                <div className="pii-list">
                  {detectedPII.map((pii, index) => (
                    <div
                      key={`${pii.type}-${index}`}
                      className={`pii-tag pii-${pii.type.toLowerCase()}`}
                    >
